...
const hsnUpdateCartProgressbar = function (e) {
  ...
  $.ajax({
        ...
        success: function(cart) {
          ...
          $(cart.items).each(function() {
            if($.inArray(this.product_type, ['mws_fee_generated']) > -1) {
              return;
            }
            sum += this.line_price;
          });
...
$(document).on('theme:cartchanged', hsnUpdateCartProgressbar);
$(hsnUpdateCartProgressbar);
