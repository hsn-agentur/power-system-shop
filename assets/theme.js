...
// ----- VLE
    reduceThumbnails()  {
      ...
      $('a.thumbnail[data-variants], a.show-gallery, .slide[data-variants]').each(function(i)  {
...
// VLE
          var $items = $carouselItem.parent().children().filter(function() {
...
theme.hsnInitUpdatePriceInfoListener = function($content, funcRef)  {
  var updatePriceInfoHandler = function() {
...
$(document).on('theme:cartchanged', function () {
  ...
  reloadTimeout = window.setTimeout('location.reload()', 3000);
});
